...
const AddEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (employeeDetails.address) formData.append('address', employeeDetails.address);
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormError(response.data.message || 'Failed to add employee. Please try again.');
      }
    } catch (error) {
                  ...
                  <div className="text-center">
                    <div 
                      style={{
                        ...
                        ...(imagePreview ? styles.profileBorder : styles.profileDefault)
                      }}
                    >
                      {imagePreview ? (
                        <Image 

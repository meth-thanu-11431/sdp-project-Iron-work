...
const AddMachine = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append(
      "purchaseDate",
      machineDetails.purchaseDate
        ? machineDetails.purchaseDate.toISOString().split("T")[0]
        : ""
    );
    ...
    try {
      const response = await axios.post(
        "http://localhost:4000/api/machine/add",
        formData,
        {
        ...
        <Card style={styles.card}>
          ...
          <Card.Header style={styles.cardHeader}>
            <div className="d-flex align-items-center">
              ...
              <h3 style={styles.cardTitle}>Add New Machine</h3>
            </div>
          </Card.Header>
            ...
            <Form onSubmit={handleSubmit}>
              <Row>
                ...
                <Col lg={6} className="mb-4 mb-lg-0">
                  <div className="mb-4">
                    <h5 style={styles.sectionTitle}>Machine Details</h5>
                    ...
                    <Form.Group className="mb-3" controlId="description">
                      ...
                      <Form.Text className="text-muted">
                        ...
                        Provide details about machine specifications and
                        capabilities
                      </Form.Text>
                    </Form.Group>
                    ...
                    <div className="mb-4">
                      <h5 style={styles.sectionTitle}>Machine Images</h5>
                ...
                <Col lg={6}>
                  <div className="mb-4">
                    <h5 style={styles.sectionTitle}>Specifications & Status</h5>
                          ...
                          <span
                            className={`badge ${
                              machineDetails.status === "Active"
                                ? "bg-success"
                                : machineDetails.status === "In Maintenance"
                    ...
                    >
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          >
                            Add all relevant details about the machine to help
                            identify and track it in the system. The machine
                            name is required, but other fields are optional.
                          </p>
                        </div>
                      </div>
                    </div>
